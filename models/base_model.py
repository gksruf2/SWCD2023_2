...
class BaseModel():
    ...
    def get_self_image_paths(self):
        return self.self_image_paths
    ...
    def save_self_results(self, save_data, old_size, data_ext='jpg'):
        """Save the training or testing results to disk"""
        img_paths = self.get_self_image_paths()
